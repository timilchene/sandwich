...
streamlit.dataframe(meat_list)
streamlit.dataframe(greens_list)
streamlit.dataframe(spreads_list)
streamlit.dataframe(bread_list)
streamlit.dataframe(cheese_list)
streamlit.dataframe(extra_list)
